...
DEFAULT_PROMO_VARIANTS: list[str] = [
    (
        "<b>☀️ Новый день — новые смены</b>\n\n"
        "Доброе утро! Мы уже в эфире: собираем вакансии и публикуем сюда лучшие в превью.\n\n"
        "Ищете работу на сегодня или на неделю? Откройте бота — там фильтры, метро и "
        "быстрый отклик с анкетой."
    ),
    (
